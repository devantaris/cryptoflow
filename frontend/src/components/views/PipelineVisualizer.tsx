      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 pb-6 border-b border-zinc-800">
        <div>
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-white tracking-tight">
            5-Stage Cryptographic Pipeline Visualizer
          </h2>
          <p className="text-xs text-zinc-400 mt-1 max-w-2xl font-sans">
            Observe the step-by-step state machine transitions from raw modality ingestion to deterministic HMAC binding and split-courier emission.
          </p>
        </div>
